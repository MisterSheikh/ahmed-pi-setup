...
// --- Claude: reasoning and per-request occupancy -----------------------------

test("Claude reasoning uses adaptive thinking and native effort levels", () => {
  assert.deepEqual(claudeReasoningOptions("high"), {
    effort: "high",
